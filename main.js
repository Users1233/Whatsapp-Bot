...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai, @user!\n\nSelamat datang di grup *@subject*\n\nSemoga harimu menyenangkan\n\nUntuk menggunakan bot balas #menu\n\n\n*Deskripsi Group :*\n@desc'
  conn.bye = 'Selamat tinggal @user! Kami akan mengingatmu ...\n\nSemoga tetap sehat diluar sana'
  conn.spromote = '@user sekarang admin!'
  conn.sdemote = '@user sekarang bukan admin (Member) !'
