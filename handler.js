  ...
  async handler(chatUpdate) {
    ...
    try {
      ...
      try {
        ...
        if (warn =< 5){
          m.reply(`User sudah melebihi batas Warning dengan otomatis user akan di banned !!`)
        ...
        if (chat) {
          ...
          sWelcome: '',
          sBye: '',
          sPromote: 'Berhasil Menjadikan Admin Group',
          sDemote: 'Berhasil Menjadikan Member Group (Not - Admin)',
          delete: true,
          antiLink: false,
        }
      } catch (e) {
...
Pesan / Media yang dihapus akan dikirim ulang 
`.trim(), m.message, {
      contextInfo: {
